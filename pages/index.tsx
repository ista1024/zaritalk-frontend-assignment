    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className="w-3/4 mt-9">
          ...
          <p className="my-2">
            2. 새로운 글 작성과 좋아요 상태 유지는 실제로 api 통신을 통해
            서버에서 값을 증가시켜야 하므로, 클라이언트에서 증가시킨 값을
            유지하는 것이 아닌, API 통신 코드예제를 작성하였습니다.
          </p>
          <p className="my-2">
            3. viewCount는 서버에서 데이터를 보내줄 때 select 이후 update해야
            하는 것으로 api 샘플코드를 작성하였습니다.
          </p>
          <p className="my-2">
